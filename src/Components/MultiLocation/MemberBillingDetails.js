...
const MemberBillingDetails = ({
  ...
  const calculateSrvcBudget = () => {
    ...
    if (isDatafetched)
      var remainingBudget = parseInt(srvc_rem) - totalServiceCost;
    else var remainingBudget = formData.srvcCost - totalServiceCost;
  ...
  const calculateMiscBudget = () => {
    ...
    if (isDatafetched) var remainingBudget = misc_rem - newMiscCost;
    else var remainingBudget = formData.miscCost - newMiscCost;
