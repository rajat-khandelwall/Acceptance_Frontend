...
const AcceptanceUpdate = ({ formData, setFormData }) => {
  ...
  const handleInputChange = (e) => {
    ...
    if (name === "generatedDate") {
      ...
      else fetchFormDataFromApi(brand, value, agreementNumber);
    }
  ...
  const handleFormSubmit = async (formData) => {
    try {
      await ApiService.updateBilling(formData);
  ...
  const handleAgreementNumberChange = async (e, selectedDate) => {
    ...
    fetchFormDataFromApi(brand, selectedDate, value);
  };
      ...
      {showBanner && (
        <div style={bannerStyle}>
          <span>
            ...
            projects whose team is present on a Single location.<br></br>For
            updation, just select{" "}
            <b>Brand, Its Generated Date then Agreement number!</b>
          </span>
...
export default AcceptanceUpdate;
